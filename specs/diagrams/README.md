...
| 7 | [Sandbox Architecture](./07-sandbox-architecture.md) | `flowchart TB` | Multi-provider: Docker, K8s, Nomad, AgentCore |
| 8 | [Authentication Flow](./08-authentication-flow.md) | `sequenceDiagram` | GitHub OAuth -> sessions -> RBAC |
| 9 | [Deployment Architecture](./09-deployment-architecture.md) | `flowchart TB` | Docker Compose, Caddy, services |
