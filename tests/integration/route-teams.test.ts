...
describe('Team Routes (IT-1100)', () => {
  ...
  describe('DELETE /api/teams/:id', () => {
    it('IT-1122: deletes team and cascades to all related tables', async () => {
      ...
      // Migration v43 dropped the legacy team_id column; tags are now scoped
      // only to project_folder_id. The cascade-delete behaviour is unchanged
      // — folder cascades when its team is deleted.
