...
const DIAGRAM_PATH = path.resolve(__dirname, '../docs/_tenancy-model.html');

test.describe('Tenancy Model Diagram - overlap validation', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(`file://${DIAGRAM_PATH}`);
