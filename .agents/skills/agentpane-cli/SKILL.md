...
With a skill assigned (skill ID is the directory name under `.Codex/skills/`):
...
Agents are Codex-powered workers that execute tasks. Each agent runs in its own git worktree for isolation.
