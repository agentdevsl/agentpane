...
export const SessionErrors = {
  ...
  PROTOCOL_MISMATCH: (message: string, details?: Record<string, unknown>) =>
    createError('SESSION_STREAM_PROTOCOL_MISMATCH', message, 409, details),
...
export type SessionError =
  ...
  | ReturnType<typeof SessionErrors.PROTOCOL_MISMATCH>
