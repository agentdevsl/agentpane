...
describe('buildTopologyFromEvents', () => {
  ...
  describe('complex topology', () => {
    it('builds a tree with orchestrator, spawned children, progress, and completion', () => {
      ...
      // orch + coder + tester = 3 nodes (the synthetic agent-type group
      // node was removed once cluster overlay rendering took over —
      // see commit 1b9d7d11). Edges: orch→coder, orch→tester = 2.
